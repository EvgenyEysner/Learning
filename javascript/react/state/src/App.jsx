...
export default function App() {
  ...
  const tabCards = document.getElementsByClassName('card')
    ...
    <>
      ...
      <div className="app">
        ...
        <div className="tab-buttons">
          <button onClick={()=> handleTabChange} className="tab-button  active">Tab 1</button>
          <button onClick={()=> handleTabChange} className="tab-button">Tab 2</button>
          <button onClick={()=> handleTabChange} className="tab-button">Tab 3</button>
        </div>
